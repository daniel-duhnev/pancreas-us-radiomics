...
One study (47\_01) was excluded from all analyses because the hospital confirmed that no images were available for this patient visit. Three additional studies (34\_02, 40\_02, 41\_03) were integrated during the course of the project after the initial data transfer, bringing the total number of studies with extracted radiomics features to 137. Of these, 134 were included in the merged radiomics--clinical dataset used for statistical and machine learning analyses, as three studies lacked matching entries in the clinical spreadsheet.
...
Studies in merged dataset & 134 \\
No rejection studies & 98 \\
Rejection studies & 40 \\
...
Feature extraction was applied to all 137 preprocessed studies, producing a feature matrix of 137 rows (studies) and 93 columns (features). No extraction failures occurred. This matrix was subsequently merged with the clinical database, yielding 134 studies with complete radiomics and clinical data for downstream analysis.
