...
This folder contains documentation for reproducing and understanding the project.
...
The `legacy/` folder contains plans and specs that have been fully completed. They are kept for historical context but are not needed for day-to-day work.
